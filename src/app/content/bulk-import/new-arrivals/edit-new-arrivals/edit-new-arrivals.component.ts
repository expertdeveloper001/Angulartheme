...
@Component({
  selector: 'app-edit-new-arrivals',
  templateUrl: './edit-new-arrivals.component.html',
  styleUrls: ['./edit-new-arrivals.component.css']
})
export class EditNewArrivalsComponent implements OnInit {
  ...
  back(){
	this.router.navigate(['bulk-import/new-arrivals']);	
  }
}
