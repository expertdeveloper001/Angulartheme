...
export class FeaturedItemsComponent implements OnInit {
	...
	// EditSpecials(row){
		// window.localStorage.removeItem("editfeaturedItemId");
		// window.localStorage.setItem("editfeaturedItemId", row.seq.toString());
		// this.router.navigate(['bulk-import/featured-items/edit-featured-items']);  
	// }
    ...
    gotoManageImage(){
		this.router.navigate(['bulk-import/new-specials/manage-image-sequence']);
	}
