...
@Component({
  selector: 'app-edit-featured-items',
  templateUrl: './edit-featured-items.component.html',
  styleUrls: ['./edit-featured-items.component.css']
})
export class EditFeaturedItemsComponent implements OnInit {
    ...
    ngOnInit() {	   
		...
		this.fiId = window.localStorage.getItem("editfeaturedItemId");
	...
	back(){
	    this.router.navigate(['bulk-import/featured-items']);	
	}
}
